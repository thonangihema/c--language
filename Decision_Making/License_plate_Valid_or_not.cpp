...
int main()
{
 string s;
  ...
  if(s.length()==6)
  {
    if(((s[0]<91)&&(s[0]>64))&&((s[1]<91)&&(s[1]>64))&&((s[2]<91)&&(s[2]>64))&&((s[3]<58)&&(s[3]>48))&&((s[4]<58)&&(s[4]>48))&&((s[5]<58)&&(s[5]>48)))
    {
        cout<<"Valid";
    }
    else
  ...
  {
    if(((s[0]<58)&&(s[0]>48))&&((s[1]<58)&&(s[1]>48))&&((s[2]<58)&&(s[2]>48))&&((s[3]<58)&&(s[3]>48))&&((s[4]<91)&&(s[4]>64))&&((s[5]<91)&&(s[5]>64))&&((s[6]<91)&&(s[6]>64)))
    {
      cout<<"Valid";
    }
    else
